// ═══════════════════════════════════════════════
// Landing Page Icons — Lucide-style inline SVGs
// ═══════════════════════════════════════════════
...
export function IconScissors({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
...
export function IconTarget({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
      <circle cx="12" cy="12" r="10" />
...
export function IconEyeOff({ size = 20, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
...
export function IconBookOpen({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
      <path d="M12 7v14" />
...
export function IconLanguages({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
      <path d="m5 8 6 6" />
...
export function IconMoon({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
...
export function IconTwitter({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
...
export function IconLoader({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
      <path d="M12 2v4" />
...
export function IconShield({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
...
export function IconMessageCircle({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
...
export function IconGraduationCap({ size = 24, ...props }) {
  return (
    <svg {...defaultProps} width={size} height={size} {...props}>
